...
const (
	Destination_NONE            Destination = 0
	Destination_MOTOR           Destination = 1
	Destination_MICROCONTROLLER Destination = 2
)
...
func (User_Roles) EnumDescriptor() ([]byte, []int) {
	return file_ui_proto_rawDescGZIP(), []int{17, 0}
}

type ControlConfig_ControlType int32

const (
	ControlConfig_TWO_STATE_BUTTON    ControlConfig_ControlType = 0
	ControlConfig_SINGLE_STATE_BUTTON ControlConfig_ControlType = 1
	ControlConfig_ICON_BUTTON         ControlConfig_ControlType = 2
)

// Enum value maps for ControlConfig_ControlType.
var (
	ControlConfig_ControlType_name = map[int32]string{
		0: "TWO_STATE_BUTTON",
		1: "SINGLE_STATE_BUTTON",
		2: "ICON_BUTTON",
	}
	ControlConfig_ControlType_value = map[string]int32{
		"TWO_STATE_BUTTON":    0,
		"SINGLE_STATE_BUTTON": 1,
		"ICON_BUTTON":         2,
	}
)

func (x ControlConfig_ControlType) Enum() *ControlConfig_ControlType {
	p := new(ControlConfig_ControlType)
	*p = x
	return p
}

func (x ControlConfig_ControlType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ControlConfig_ControlType) Descriptor() protoreflect.EnumDescriptor {
	return file_ui_proto_enumTypes[2].Descriptor()
}

func (ControlConfig_ControlType) Type() protoreflect.EnumType {
	return &file_ui_proto_enumTypes[2]
}

func (x ControlConfig_ControlType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ControlConfig_ControlType.Descriptor instead.
func (ControlConfig_ControlType) EnumDescriptor() ([]byte, []int) {
	return file_ui_proto_rawDescGZIP(), []int{25, 0}
}
...
func (x *MetricUpdate) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
// This represent a setting that is a single bounded between a
...
type Setting struct {
	...
	Destination Destination `protobuf:"varint,1,opt,name=destination,proto3,enum=v1.Destination" json:"destination,omitempty"`
	Value       float64     `protobuf:"fixed64,2,opt,name=value,proto3" json:"value,omitempty"`
...
func (x *Setting) GetDestination() Destination {
	if x != nil {
...
func (x *Setting) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type SettingUpdate struct {
	...
	Name     string  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Value    float64 `protobuf:"fixed64,2,opt,name=value,proto3" json:"value,omitempty"`
	IsStatic bool    `protobuf:"varint,3,opt,name=isStatic,proto3" json:"isStatic,omitempty"`
}
...
func (x *SettingUpdate) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
func (x *TargetUpdate) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type Selector struct {
	...
	PossibleChoices []string `protobuf:"bytes,3,rep,name=possibleChoices,proto3" json:"possibleChoices,omitempty"`
	IsStatic        bool     `protobuf:"varint,9,opt,name=isStatic,proto3" json:"isStatic,omitempty"`
}
...
func (x *Selector) GetChoice() string {
	if x != nil {
		return x.Choice
	}
	return ""
...
func (x *Selector) GetPossibleChoices() []string {
	if x != nil {
...
func (x *Selector) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
func (x *SelectorUpdate) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type ChoiceUpdate struct {
	...
	NewChoice    string `protobuf:"bytes,2,opt,name=newChoice,proto3" json:"newChoice,omitempty"`
	IsStatic     bool   `protobuf:"varint,3,opt,name=isStatic,proto3" json:"isStatic,omitempty"`
}
...
func (x *ChoiceUpdate) GetNewChoice() string {
	if x != nil {
		return x.NewChoice
	}
	return ""
...
func (x *ChoiceUpdate) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type GraphSettings struct {
	...
	Name               string   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	UnitVerticalAxis   string   `protobuf:"bytes,2,opt,name=unitVerticalAxis,proto3" json:"unitVerticalAxis,omitempty"`
	UnitHorizontalAxis string   `protobuf:"bytes,3,opt,name=unitHorizontalAxis,proto3" json:"unitHorizontalAxis,omitempty"`
	VerticalAxis       string   `protobuf:"bytes,4,opt,name=verticalAxis,proto3" json:"verticalAxis,omitempty"`
	HorizontalAxis     string   `protobuf:"bytes,5,opt,name=horizontalAxis,proto3" json:"horizontalAxis,omitempty"`
	Points             []*Point `protobuf:"bytes,6,rep,name=points,proto3" json:"points,omitempty"`
	IsStatic           bool     `protobuf:"varint,7,opt,name=isStatic,proto3" json:"isStatic,omitempty"`
}

func (x *GraphSettings) Reset() {
	*x = GraphSettings{}
	if protoimpl.UnsafeEnabled {
...
func (x *GraphSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GraphSettings) ProtoMessage() {}

func (x *GraphSettings) ProtoReflect() protoreflect.Message {
	mi := &file_ui_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GraphSettings.ProtoReflect.Descriptor instead.
func (*GraphSettings) Descriptor() ([]byte, []int) {
	return file_ui_proto_rawDescGZIP(), []int{13}
}

func (x *GraphSettings) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GraphSettings) GetUnitVerticalAxis() string {
	if x != nil {
		return x.UnitVerticalAxis
	}
	return ""
}

func (x *GraphSettings) GetUnitHorizontalAxis() string {
	if x != nil {
		return x.UnitHorizontalAxis
	}
	return ""
}

func (x *GraphSettings) GetVerticalAxis() string {
	if x != nil {
...
func (x *GraphSettings) GetHorizontalAxis() string {
	if x != nil {
...
func (x *GraphSettings) GetPoints() []*Point {
	if x != nil {
		return x.Points
	}
	return nil
...
func (x *GraphSettings) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type GraphUpdate struct {
	...
	Name      string   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	NewPoints []*Point `protobuf:"bytes,2,rep,name=newPoints,proto3" json:"newPoints,omitempty"`
	IsStatic  bool     `protobuf:"varint,3,opt,name=isStatic,proto3" json:"isStatic,omitempty"`
}
...
func (x *GraphUpdate) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GraphUpdate) GetNewPoints() []*Point {
	if x != nil {
		return x.NewPoints
	}
	return nil
...
func (x *GraphUpdate) GetIsStatic() bool {
	if x != nil {
		return x.IsStatic
	}
	return false
...
type Recipe struct {
	...
	Graphs    []*GraphSettings `protobuf:"bytes,6,rep,name=graphs,proto3" json:"graphs,omitempty"`
}
...
func (x *Recipe) GetGraphs() []*GraphSettings {
	if x != nil {
		return x.Graphs
	}
	return nil
...
type ControlConfig struct {
	...
	Type  ControlConfig_ControlType `protobuf:"varint,1,opt,name=type,proto3,enum=v1.ControlConfig_ControlType" json:"type,omitempty"`
	Id    string                    `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	Title string                    `protobuf:"bytes,3,opt,name=title,proto3" json:"title,omitempty"`
	// Used with the 2-state and 1-state buttons
	StateText  []string `protobuf:"bytes,4,rep,name=state_text,json=stateText,proto3" json:"state_text,omitempty"`
	ActionName string   `protobuf:"bytes,5,opt,name=action_name,json=actionName,proto3" json:"action_name,omitempty"`
	// Used with all button type
	StateActionPayload []string `protobuf:"bytes,6,rep,name=state_action_payload,json=stateActionPayload,proto3" json:"state_action_payload,omitempty"`
	// Used with Icon button
	IconType string `protobuf:"bytes,7,opt,name=iconType,proto3" json:"iconType,omitempty"`
}
...
func (x *ControlConfig) GetType() ControlConfig_ControlType {
	if x != nil {
		return x.Type
	}
	return ControlConfig_TWO_STATE_BUTTON
}

func (x *ControlConfig) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ControlConfig) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *ControlConfig) GetStateText() []string {
	if x != nil {
		return x.StateText
	}
	return nil
...
func (x *ControlConfig) GetActionName() string {
	if x != nil {
		return x.ActionName
	}
	return ""
...
func (x *ControlConfig) GetStateActionPayload() []string {
	if x != nil {
		return x.StateActionPayload
	}
	return nil
}

func (x *ControlConfig) GetIconType() string {
	if x != nil {
		return x.IconType
	}
	return ""
...
type ControlConfigs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Configs []*ControlConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}

func (x *ControlConfigs) Reset() {
	*x = ControlConfigs{}
	if protoimpl.UnsafeEnabled {
...
func (x *ControlConfigs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ControlConfigs) ProtoMessage() {}

func (x *ControlConfigs) ProtoReflect() protoreflect.Message {
	mi := &file_ui_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ControlConfigs.ProtoReflect.Descriptor instead.
func (*ControlConfigs) Descriptor() ([]byte, []int) {
	return file_ui_proto_rawDescGZIP(), []int{26}
}

func (x *ControlConfigs) GetConfigs() []*ControlConfig {
	if x != nil {
		return x.Configs
	}
	return nil
...
var file_ui_proto_rawDesc = []byte{
	...
	0x22, 0x6e, 0x0a, 0x0c, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x37, 0x0a, 0x0b, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x09,
	0x0a, 0x05, 0x4d, 0x4f, 0x54, 0x4f, 0x52, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x4d, 0x49, 0x43,
	0x52, 0x4f, 0x43, 0x4f, 0x4e, 0x54, 0x52, 0x4f, 0x4c, 0x4c, 0x45, 0x52, 0x10, 0x02, 0x32, 0xc6,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x32, 0xfd, 0x04, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x74,
	...
	,
	...
	,
...
var file_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_ui_proto_goTypes = []interface{}{
	(Destination)(0),               // 0: v1.Destination
	(User_Roles)(0),                // 1: v1.User.Roles
	(ControlConfig_ControlType)(0), // 2: v1.ControlConfig.ControlType
	(*MetricConfig)(nil),           // 3: v1.MetricConfig
	(*MetricConfigs)(nil),          // 4: v1.MetricConfigs
	(*MetricUpdate)(nil),           // 5: v1.MetricUpdate
	(*MetricUpdates)(nil),          // 6: v1.MetricUpdates
	(*Setting)(nil),                // 7: v1.Setting
	(*Target)(nil),                 // 8: v1.Target
	(*SettingUpdate)(nil),          // 9: v1.SettingUpdate
	(*TargetUpdate)(nil),           // 10: v1.TargetUpdate
	...
	(*Point)(nil),                  // 15: v1.Point
	(*GraphSettings)(nil),          // 16: v1.GraphSettings
	(*GraphUpdate)(nil),            // 17: v1.GraphUpdate
	(*Recipe)(nil),                 // 18: v1.Recipe
	(*UUIDS)(nil),                  // 19: v1.UUIDS
	(*User)(nil),                   // 20: v1.User
	(*Users)(nil),                  // 21: v1.Users
	(*WifiCredentials)(nil),        // 22: v1.WifiCredentials
	(*WifiNames)(nil),              // 23: v1.WifiNames
	(*WifiStatus)(nil),             // 24: v1.WifiStatus
	(*Action)(nil),                 // 25: v1.Action
	(*ControlEvent)(nil),           // 26: v1.ControlEvent
	(*SendResponse)(nil),           // 27: v1.SendResponse
	(*ControlConfig)(nil),          // 28: v1.ControlConfig
	(*ControlConfigs)(nil),         // 29: v1.ControlConfigs
	(*Empty)(nil),                  // 30: v1.Empty
	(*DoubleValue)(nil),            // 31: v1.DoubleValue
	(*FloatValue)(nil),             // 32: v1.FloatValue
	(*Int64Value)(nil),             // 33: v1.Int64Value
	(*UInt64Value)(nil),            // 34: v1.UInt64Value
	(*Int32Value)(nil),             // 35: v1.Int32Value
	(*UInt32Value)(nil),            // 36: v1.UInt32Value
	(*BoolValue)(nil),              // 37: v1.BoolValue
	(*StringValue)(nil),            // 38: v1.StringValue
	(*BytesValue)(nil),             // 39: v1.BytesValue
}
var file_ui_proto_depIdxs = []int32{
	3,  // 0: v1.MetricConfigs.configs:type_name -> v1.MetricConfig
	5,  // 1: v1.MetricUpdates.updates:type_name -> v1.MetricUpdate
	0,  // 2: v1.Setting.destination:type_name -> v1.Destination
	8,  // 3: v1.Setting.target:type_name -> v1.Target
	11, // 4: v1.Selectors.selectors:type_name -> v1.Selector
	15, // 5: v1.GraphSettings.points:type_name -> v1.Point
	15, // 6: v1.GraphUpdate.newPoints:type_name -> v1.Point
	7,  // 7: v1.Recipe.settings:type_name -> v1.Setting
	11, // 8: v1.Recipe.selectors:type_name -> v1.Selector
	16, // 9: v1.Recipe.graphs:type_name -> v1.GraphSettings
	1,  // 10: v1.User.role:type_name -> v1.User.Roles
	20, // 11: v1.Users.users:type_name -> v1.User
	2,  // 12: v1.ControlConfig.type:type_name -> v1.ControlConfig.ControlType
	28, // 13: v1.ControlConfigs.configs:type_name -> v1.ControlConfig
	30, // 14: v1.MetricService.GetAll:input_type -> v1.Empty
	30, // 15: v1.MetricService.Subscribe:input_type -> v1.Empty
	30, // 16: v1.MetricService.ReadConfig:input_type -> v1.Empty
	4,  // 17: v1.MetricService.UpdateConfig:input_type -> v1.MetricConfigs
	30, // 18: v1.SettingService.CreateRecipe:input_type -> v1.Empty
	30, // 19: v1.SettingService.ReadRecipesUUID:input_type -> v1.Empty
	38, // 20: v1.SettingService.ReadRecipe:input_type -> v1.StringValue
	30, // 21: v1.SettingService.ReadCurrentRecipe:input_type -> v1.Empty
	30, // 22: v1.SettingService.ReadSelectorList:input_type -> v1.Empty
	9,  // 23: v1.SettingService.UpdateSetting:input_type -> v1.SettingUpdate
	10, // 24: v1.SettingService.UpdateUncertainty:input_type -> v1.TargetUpdate
	13, // 25: v1.SettingService.UpdateSelectedChoice:input_type -> v1.SelectorUpdate
	14, // 26: v1.SettingService.UpdateChoice:input_type -> v1.ChoiceUpdate
	17, // 27: v1.SettingService.UpdateGraphSettings:input_type -> v1.GraphUpdate
	38, // 28: v1.SettingService.UpdateCurrentRecipe:input_type -> v1.StringValue
	18, // 29: v1.SettingService.UpdateRecipe:input_type -> v1.Recipe
	38, // 30: v1.SettingService.DeleteRecipe:input_type -> v1.StringValue
	30, // 31: v1.AuthentificationService.ReadUserList:input_type -> v1.Empty
	20, // 32: v1.AuthentificationService.UpdateCurrentUser:input_type -> v1.User
	30, // 33: v1.AuthentificationService.GetCurrentUser:input_type -> v1.Empty
	30, // 34: v1.NetworkService.ReadStatus:input_type -> v1.Empty
	30, // 35: v1.NetworkService.ReadWifiList:input_type -> v1.Empty
	22, // 36: v1.NetworkService.ConnectWifi:input_type -> v1.WifiCredentials
	25, // 37: v1.ControlService.Send:input_type -> v1.Action
	30, // 38: v1.ControlService.Subscribe:input_type -> v1.Empty
	30, // 39: v1.ControlService.ReadConfig:input_type -> v1.Empty
	30, // 40: v1.MotorControlService.Home:input_type -> v1.Empty
	30, // 41: v1.MotorControlService.StartCycle:input_type -> v1.Empty
	30, // 42: v1.MotorControlService.StopCycle:input_type -> v1.Empty
	6,  // 43: v1.MetricService.GetAll:output_type -> v1.MetricUpdates
	6,  // 44: v1.MetricService.Subscribe:output_type -> v1.MetricUpdates
	4,  // 45: v1.MetricService.ReadConfig:output_type -> v1.MetricConfigs
	30, // 46: v1.MetricService.UpdateConfig:output_type -> v1.Empty
	18, // 47: v1.SettingService.CreateRecipe:output_type -> v1.Recipe
	19, // 48: v1.SettingService.ReadRecipesUUID:output_type -> v1.UUIDS
	18, // 49: v1.SettingService.ReadRecipe:output_type -> v1.Recipe
	18, // 50: v1.SettingService.ReadCurrentRecipe:output_type -> v1.Recipe
	12, // 51: v1.SettingService.ReadSelectorList:output_type -> v1.Selectors
	30, // 52: v1.SettingService.UpdateSetting:output_type -> v1.Empty
	30, // 53: v1.SettingService.UpdateUncertainty:output_type -> v1.Empty
	30, // 54: v1.SettingService.UpdateSelectedChoice:output_type -> v1.Empty
	30, // 55: v1.SettingService.UpdateChoice:output_type -> v1.Empty
	30, // 56: v1.SettingService.UpdateGraphSettings:output_type -> v1.Empty
	30, // 57: v1.SettingService.UpdateCurrentRecipe:output_type -> v1.Empty
	30, // 58: v1.SettingService.UpdateRecipe:output_type -> v1.Empty
	30, // 59: v1.SettingService.DeleteRecipe:output_type -> v1.Empty
	21, // 60: v1.AuthentificationService.ReadUserList:output_type -> v1.Users
	30, // 61: v1.AuthentificationService.UpdateCurrentUser:output_type -> v1.Empty
	20, // 62: v1.AuthentificationService.GetCurrentUser:output_type -> v1.User
	24, // 63: v1.NetworkService.ReadStatus:output_type -> v1.WifiStatus
	23, // 64: v1.NetworkService.ReadWifiList:output_type -> v1.WifiNames
	30, // 65: v1.NetworkService.ConnectWifi:output_type -> v1.Empty
	27, // 66: v1.ControlService.Send:output_type -> v1.SendResponse
	26, // 67: v1.ControlService.Subscribe:output_type -> v1.ControlEvent
	29, // 68: v1.ControlService.ReadConfig:output_type -> v1.ControlConfigs
	30, // 69: v1.MotorControlService.Home:output_type -> v1.Empty
	30, // 70: v1.MotorControlService.StartCycle:output_type -> v1.Empty
	30, // 71: v1.MotorControlService.StopCycle:output_type -> v1.Empty
...
func file_ui_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ui_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ui_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ui_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ui_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
...
type SettingServiceClient interface {
	...
	// UpdateGraphSettings updates the settings of a graph
	UpdateGraphSettings(ctx context.Context, in *GraphUpdate, opts ...grpc.CallOption) (*Empty, error)
...
func (c *settingServiceClient) UpdateGraphSettings(ctx context.Context, in *GraphUpdate, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/v1.SettingService/UpdateGraphSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SettingServiceServer interface {
	...
	// UpdateGraphSettings updates the settings of a graph
	UpdateGraphSettings(context.Context, *GraphUpdate) (*Empty, error)
	// UpdateCurrentRecipe tells the backend what is the active recipe
...
func (*UnimplementedSettingServiceServer) UpdateGraphSettings(context.Context, *GraphUpdate) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateGraphSettings not implemented")
}
...
func _SettingService_UpdateGraphSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GraphUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingServiceServer).UpdateGraphSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.SettingService/UpdateGraphSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingServiceServer).UpdateGraphSettings(ctx, req.(*GraphUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SettingService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateGraphSettings",
			Handler:    _SettingService_UpdateGraphSettings_Handler,
		},
		{
...
type ControlServiceClient interface {
	...
	ReadConfig(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ControlConfigs, error)
}
...
func (c *controlServiceClient) ReadConfig(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ControlConfigs, error) {
	out := new(ControlConfigs)
	err := c.cc.Invoke(ctx, "/v1.ControlService/ReadConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControlServiceServer interface {
	...
	ReadConfig(context.Context, *Empty) (*ControlConfigs, error)
}
...
func (*UnimplementedControlServiceServer) ReadConfig(context.Context, *Empty) (*ControlConfigs, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadConfig not implemented")
}
...
func _ControlService_ReadConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControlServiceServer).ReadConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.ControlService/ReadConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControlServiceServer).ReadConfig(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ControlService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadConfig",
			Handler:    _ControlService_ReadConfig_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
