...
/// Descriptor for `Destination`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List destinationDescriptor = $convert.base64Decode('CgtEZXN0aW5hdGlvbhIICgROT05FEAASCQoFTU9UT1IQARITCg9NSUNST0NPTlRST0xMRVIQAg==');
...
final $typed_data.Uint8List metricUpdateDescriptor = $convert.base64Decode('CgxNZXRyaWNVcGRhdGUSEgoEbmFtZRgBIAEoCVIEbmFtZRIUCgV2YWx1ZRgCIAEoAVIFdmFsdWUSFgoGdGFyZ2V0GAMgASgBUgZ0YXJnZXQSHAoJdGltZXN0YW1wGAQgASgJUgl0aW1lc3RhbXA=');
...
final $typed_data.Uint8List settingDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List settingUpdateDescriptor = $convert.base64Decode('Cg1TZXR0aW5nVXBkYXRlEhIKBG5hbWUYASABKAlSBG5hbWUSFAoFdmFsdWUYAiABKAFSBXZhbHVlEhoKCGlzU3RhdGljGAMgASgIUghpc1N0YXRpYw==');
...
final $typed_data.Uint8List targetUpdateDescriptor = $convert.base64Decode('CgxUYXJnZXRVcGRhdGUSEgoEbmFtZRgBIAEoCVIEbmFtZRIUCgV2YWx1ZRgCIAEoAVIFdmFsdWUSGgoIaXNTdGF0aWMYAyABKAhSCGlzU3RhdGlj');
...
final $typed_data.Uint8List selectorDescriptor = $convert.base64Decode('CghTZWxlY3RvchISCgRuYW1lGAEgASgJUgRuYW1lEhYKBmNob2ljZRgCIAEoCVIGY2hvaWNlEigKD3Bvc3NpYmxlQ2hvaWNlcxgDIAMoCVIPcG9zc2libGVDaG9pY2VzEhoKCGlzU3RhdGljGAkgASgIUghpc1N0YXRpYw==');
...
final $typed_data.Uint8List selectorUpdateDescriptor = $convert.base64Decode('Cg5TZWxlY3RvclVwZGF0ZRISCgRuYW1lGAEgASgJUgRuYW1lEh4KCmNob2ljZU5hbWUYAiABKAlSCmNob2ljZU5hbWUSGgoIaXNTdGF0aWMYAyABKAhSCGlzU3RhdGlj');
...
final $typed_data.Uint8List choiceUpdateDescriptor = $convert.base64Decode('CgxDaG9pY2VVcGRhdGUSIgoMbmFtZVNlbGVjdG9yGAEgASgJUgxuYW1lU2VsZWN0b3ISHAoJbmV3Q2hvaWNlGAIgASgJUgluZXdDaG9pY2USGgoIaXNTdGF0aWMYAyABKAhSCGlzU3RhdGlj');
...
@$core.Deprecated('Use graphSettingsDescriptor instead')
...
/// Descriptor for `GraphSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List graphSettingsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use graphUpdateDescriptor instead')
...
/// Descriptor for `GraphUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List graphUpdateDescriptor = $convert.base64Decode('CgtHcmFwaFVwZGF0ZRISCgRuYW1lGAEgASgJUgRuYW1lEicKCW5ld1BvaW50cxgCIAMoCzIJLnYxLlBvaW50UgluZXdQb2ludHMSGgoIaXNTdGF0aWMYAyABKAhSCGlzU3RhdGlj');
...
final $typed_data.Uint8List recipeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List controlConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use controlConfigsDescriptor instead')
...
/// Descriptor for `ControlConfigs`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List controlConfigsDescriptor = $convert.base64Decode('Cg5Db250cm9sQ29uZmlncxIrCgdjb25maWdzGAEgAygLMhEudjEuQ29udHJvbENvbmZpZ1IHY29uZmlncw==');
